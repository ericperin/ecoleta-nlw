...
const CreatePoint = () => {
  ...
  async function handleSubmit(event: FormEvent){
    ...
    await axios.post('points', data).then((response) => {
        ...
        <fieldset>
          ...
          <div className='field-group'>
            <div className='field'>
              ...
              <select name='uf' id='uf' value={selectedUf} onChange={handleUfSelected}>
            ...
            <div className='field'>
              ...
              <select name='city' id='city' value={selectedCity} onChange={handleCitySelected}>
